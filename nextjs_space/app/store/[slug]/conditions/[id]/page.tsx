...
export default function ConditionPage() {
  ...
  const symptoms =
    typeof condition.symptoms === "object" && condition.symptoms
      ? condition.symptoms
      : { physical: [] };
  ...
  const medicalCannabis =
    typeof condition.medicalCannabis === "object" && condition.medicalCannabis
      ? condition.medicalCannabis
      : { content1: "", content2: "" };
              ...
              <div id="symptoms" className="scroll-mt-32">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  {symptoms.psychological &&
                    symptoms.psychological.length > 0 && (
                      <div
                        className="p-6 rounded-xl border bg-opacity-50"
                        style={{
                          backgroundColor: "var(--tenant-color-surface)",
