...
/**
 * The product page's interactive body, unchanged from when it WAS `page.tsx`.
 *
 * SEO US-004 split it out so the route can be a Server Component: a `"use
 * client"` module cannot export `generateMetadata`, which is why this page —
 * the most-linked page type in any store — rendered the platform title. It still
