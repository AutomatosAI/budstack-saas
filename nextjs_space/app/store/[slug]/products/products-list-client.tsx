...
/**
 * The catalogue, unchanged. Split out of `page.tsx` by SEO US-007 so the route
 * can be a server component with a `generateMetadata` — a client page cannot
 * export one, and `/products` was the last store page with no canonical and no
 * title of its own. Same arrangement as the sibling detail route
 * (`[id]/page.tsx` → `ProductDetailClient`).
 */
