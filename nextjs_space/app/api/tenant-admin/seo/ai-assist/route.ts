...
/**
 * The HTTP shape of one service result. The draft itself is this route's own
 * 200; every other outcome is the shared mapping in `lib/seo/ai-assist-http.ts`,
 * which US-002's Q&A route answers with too.
 */
