...
export default async function SuperAdminLayout({
  ...
  return (
    <div className="flex min-h-screen bg-bs-bg-1">
      <SuperAdminSidebarV2 userName={userName} userEmail={userEmail} />
      <AccessibleAdminLayout theme="super-admin">
        {/* Top bar — dark band */}
        <div className="budstacks-theme sticky top-0 z-30 flex items-center justify-end px-4 py-2 md:px-8 bg-bs-bg-0 border-b border-bs-border">
          <NotificationCenter
            theme="super-admin"
