    ...
    <div className="p-8">
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-slate-600 mt-2">Complete activity history and system events</p>
        </div>
        ...
        <Card className="border-slate-200 shadow-lg">
          <CardHeader className="border-b bg-gradient-to-r from-slate-50 to-slate-100">
            ...
            <CardDescription>Platform-wide event tracking and monitoring</CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex flex-col">
                <span className="text-sm text-slate-600 mb-1">Total Events</span>
                <span className="text-2xl font-bold text-slate-900">{allEvents.length}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-sm text-slate-600 mb-1">Last 24 Hours</span>
              ...
              <div className="flex flex-col">
                <span className="text-sm text-slate-600 mb-1">Active Monitoring</span>
