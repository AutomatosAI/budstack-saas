          ...
          >
            <div className="space-y-6">
              <h2 className="text-4xl sm:text-5xl font-bold font-serif leading-tight">
                ...
                <span className="text-green-300 block">Journey Today</span>
              </h2>
              <p className="text-xl text-green-100 leading-relaxed">
                Join thousands of Portuguese patients who have found relief
                through our safe, legal, and INFARMED-regulated medical cannabis
            ...
            >
              <Link href={consultationUrl}>
                <Button
                  size="lg"
                  className="bg-white text-green-800 hover:bg-green-50 shadow-2xl hover:shadow-3xl transition-all duration-300 group"
                >
          ...
          >
            ...
            >
              ...
              <p className="text-orange-100 text-sm mb-4">
                Need immediate assistance? Our medical support team is available
                around the clock.
              </p>
              <div className="flex items-center space-x-4 text-sm">
                <span className="text-orange-200">📞 +351 21 234 5678</span>
                <span className="text-orange-200">
                  ✉️ emergency@healingbuds.pt
                </span>
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10">
            ...
            <p className="text-green-100 mb-6 max-w-2xl mx-auto">
              Our patient care team is here to guide you through every step of
              the process, from initial questions to ongoing treatment support.
            </p>
